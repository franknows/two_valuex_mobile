...
class ApproveUpdatedImages extends StatefulWidget {
  const ApproveUpdatedImages({Key? key}) : super(key: key);

  @override
  State<ApproveUpdatedImages> createState() => _ApproveUpdatedImagesState();
}

class _ApproveUpdatedImagesState extends State<ApproveUpdatedImages> {
  @override
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 4,
          title: appBarWhiteText('Approve updated images'),
          centerTitle: true,
          leading: IconButton(
            icon: const Icon(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection('XUsers')
              .where('images_verification_status', isEqualTo: 'Updated')
              .limit(200)
              .snapshots(),
