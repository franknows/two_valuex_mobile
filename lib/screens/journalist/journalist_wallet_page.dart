...
class JournalistWalletPage extends StatefulWidget {
  final String userId;
  final DocumentSnapshot userData;
  const JournalistWalletPage(
      {super.key, required this.userId, required this.userData});

  @override
  State<JournalistWalletPage> createState() => _JournalistWalletPageState();
}

class _JournalistWalletPageState extends State<JournalistWalletPage> {
  String language = '';
